...
<html>
  ...
  <body>
    <div class="rail">
      ...
      <a onclick="toggleS(this); loadPage('./pages/apiReference.php')" href="#/api-keys" class="waves-effect tooltipped btn-floating btn-flat btn-large" data-tooltip="API Docs" data-position="right">
        <i class="material-icons">library_books</i>
      </a>

      <a onclick="setTimeout(() => window.open('https://support.smartlist.ga/docs'), 500)" href="#/api-keys" class="waves-effect tooltipped btn-floating btn-flat btn-large" data-tooltip="Support" data-position="right">
        <i class="material-icons">help</i>
      </a>

      <a onclick="toggleS(this); loadPage('./pages/feedback.php')" href="#/feedback" class="waves-effect tooltipped btn-floating btn-flat btn-large" data-tooltip="API Docs" data-position="right">
